...
export default function Home() {
  return (
    <div>
      {/*Hero Section*/}
      <section className="min-h-screen flex flex-col items-center  px-4 py-20 text-center">
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold gradient-title leading-tight">
          Streamline your Workflow
          <br />
          <span className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 mt-4">
            With{" "}
            <Image
              src="/logo2.png"
              alt="vscrum"
